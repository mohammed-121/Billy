...
return "• 1 - ممنوع السب و الشتم نهائيا \n • 2 - ممنوع نشر محتوى باحي نهائيا \n • 3 - احترم صاحب قروب و الادمنيه و شكرا"
else 
...
'⠀',
        ...
        sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,' 𝙸D︙'..msg.sender_user_id_..' \n 𝚄S︙'..UserNameID..' \n Rank︙'..msg.TheRank..' \n MSG︙'..msgs..' \n .',dl_cb,nil)
        else
...
if MsgText[2] == "ردود رانج"   then return unlock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return unlock_brod(msg) end
if MsgText[2] == "ايدي رانج"   then return unlock_IID(msg) end
if MsgText[2] == "ترحيب رانج"  then return unlock_Welcome(msg) end
...
if MsgText[2] == "ردود رانج"   then return lock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return lock_brod(msg) end
if MsgText[2] == "ايدي رانج"   then return lock_IID(msg) end
if MsgText[2] == "ترحيب رانج"  then return lock_Welcome(msg) end
...
redis:setex(max..'fwd:groupsmax'..msg.sender_user_id_,300, true) 
...
redis:setex(max..'fwd:number'..msg.sender_user_id_,300, true) 
...
return '-اصدار سورس رانج  : *v'..version..'* \n➿'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ') then
if not msg.SudoBase then return "↪هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
local GetVerison = https.request('https://github.com/mohammed-121/Rang') or 0
...
sendMsg(msg.chat_id_,msg.id_,'• عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس رانج يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SourceRang"}}}
send_key(msg.sender_user_id_,'  [-قناة سورس : رانج ل](https://t.me/SourceRang)',nil,inline,msg.id_)
return false
end
...
5 ︙اوامر التسليه
⌔
6 ︙اوامر التفعيل و التعطيل
⌔
7 ︙اوامر وضع مجموعه
⌔
م المطور ︙ اوامر المطور
••━━━━━••
اوامر الرد ︙ ردود المجموعه
⌔
الوسائط ︙ لعرض الميديا
⌔
الاعدادت ︙ لعرض اعدادات مجموعه
⌔
سورس ︙ سورس البوت
••━━━━━••
...
3- مسح المــــدراء » لسمح المدراء
••━━━━━••
اوامر  الطرد | الحظر | التتقيد | منع
••━━━━━••
1- حظر » لكظر شخص من مجموعه
2- الغاء الحظر × معرف او ايدي » للغاء الحظر عن شخص
3- طرد » لطرد عضو من مجموعه
4- كتم » لمنع شخص من كتابه
5- الغاء الكتم » الغاء الكتم عن شخص
6- تقييد » لتقييد شخص من مجموعه
7- فك التقييد × معرف او ايدي » للغاء التتقيد عن شخص
8- منع × الكلمه » لمنع الكلمه من مجموعه
9- الغاء المنع » لمسح كلمه من قائمة منع
••━━━━━••
اذا تبي شي كلمني هنا>↭ ]]..SUDO_USER
...
اوامر المجموعه
••━━━━━••
الرابط » لعرض رابط مجموعه
⌔
انشاء رابط » لنشاء رابط للمجموعه
⌔
الادمنيه » لعرض ادمنيه مجموعه
⌔
المدراء » لعرض مدراء مجموعه
⌔
الوسائط » لعرض ميديا
⌔
الحمايه » لعرض اعدادات حمايه
⌔
القوانين » لعرض قوانين مجموعه
⌔
المكتومين » لعرض مكتومين
⌔
المحظورين » لعرض المحظورين
⌔
الاعدادات » لعرص اعداداا مجموعه
⌔
المجموعه » لعرض تفتصيل مجموعه
⌔
تغيير امر × الامر » لتغير امر
⌔
مسح امر × الامر » لحذف امر
⌔
قائمة الاوامر » لعرض اوامر مجموعه
⌔
••━━━━━••
...
16- قفل + فتح [الانلاين]
17- قفل + فتح [التوجيه]
18- قفل + فتح [دخول بالرابط]
19- قفل + فتح [بوتات بالطرد]
••━━━━━••
⌔ القفل بالتقييد  ⌔
••━━━━━••                                                                                        
...
⌔ اوامر الخدمه ⌔
••━━━━━••
ايدي » لعرض ايديك مع صوره
⌔
ايديي » لعرض ايديك بدون صوره
⌔
ايدي بالرد » لعرض ايدي الشخص
⌔
الرابط » لعرض رابط مجموعه
⌔
جهاتي » لعرض جهات مضافه
⌔
معلوماتي » لعرض معلوماتك
⌔
السورس » لعرض سورس البوت
⌔
الرتبه بالرد » لعرض رتبت الشخص
⌔
تفاعل بالمعرف » لعرض تفاعل شخص
⌔
التفاعل بالرد » لعرض تفاعل شخص مع رسائل
⌔
كشف بالمعرف » لعرض معلومات حساب
⌔
كشف بالرد » لعرض معلومات حساب بالتفصيل
⌔
كشف بوتات » لعرض البوتات
الموجوده داخل مجموعه
⌔
طرد بوتات » لطرد جميع البوتات
⌔
طرد محذوفين » لطرد حسابات محذوفه
⌔
••━━━━━••
...
⌔ اوامر المطور ⌔
••━━━━━••
1 تفعيل ︙ تفعيل المجموعه
2 تعطيل ︙ تعطيل المجموعه
3 اسم بوت ⌔ غادر ︙ لطرد البوت من مجموعه
4 رفع منشى ︙ لرفع العضو منشى في بوت
                    ••━━━━━••
1 اذاعه ︙ لنشر رسائل للمشتركين البوت في قروبات
2 اذاعه خاص ︙ لنشر رسائل للمشتركين البوت في الخاص
3 اذاعه عام ︙ لنشر رسائل في خاص و القروبات
4 اذاعه عام بالتوجيه ︙ لنشر الرساله للكل بلتوجيه
5 تنظيف المجموعات ︙ لطرد البوت من مجموعات وهميه
5 تنظيف المشتركين ︙ لحظر مشتركين الوهيمين
••━━━━━••
7 ⌔ تحديث
8 ⌔ تغير المطور الاساسي
••━━━━━••
اذا تبي شي كلمني هنا>↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
••━━━━━••
⌔
 الردود ︙ لعرض ردود المجموعة
⌔
 اضف رد ︙ لضافة رد جديد للمجموعه
⌔
 مسح رد ︙ لمسح رد من مجموعه
⌔
 مسح الردود ︙ لمسح جميع ردود المجموعه
⌔
 لردود العامه ︙ ردود البوت لجميع مجموعات
⌔
 اضف رد عام ︙ لضافة رد لجميع مجموعات
⌔
 مسح رد عام ︙ لمسح رد من جميع مجموعات
⌔
 مسح الردود العامه ︙ لمسح جميع ردود مجموعات
⌔
••━━━━━••
اذا تبي شي كلمني هنا>↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
...
{"تعطيل البوت خدمي","تفعيل البوت خدمي","المطورين "},
 ...
 {"اذاعه ","اذاعه خاص ","اذاعه خاص بالتوجيه "},
