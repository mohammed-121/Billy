...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
    if data.photos_[0] then 
        ...
        sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,' ⌾ | UserName  𓃠 '..UserNameID..' .\n ⌾ | MsG  𓃠  '..msgs..' .\n• .⌾ | Rank  𓃠  '..msg.TheRank..' .\n• ⌾ | Channel  𓃠  '..msg.sender_user_id_..' .\n  ⌾ | 𝒊𝒅  𓃠  @SourceRang .',dl_cb,nil)
        else
