...
if MsgText[1] == "ايدي" or MsgText[1]:lower() == "id" then
  ...
  if data.username_ then UserNameID = "• USE 𖦹 @"..data.username_.." \n" else UserNameID = "" end
...
local inline = {{{text="قناة السورس .",url="t.me/@SourceBilly"}}}
send_key(msg.sender_user_id_,'[ قناة سورس dreem .](t.me/@SourceBilly)',nil,inline,msg.id_)
return false
end
...
return [[
  ⋆ مطـور السورس  ⇽  [ناصر](http://t.me/vvvj9)
⋆ مطـور السورس  ⇽  [صمت](t.me/q10_7)
⋆ قناة السورس   ⇽  [SourceBilly](t.me/SourceBilly)
⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆
⠀⠀
]]
end
