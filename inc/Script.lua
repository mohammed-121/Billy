...
6 - م6 اوامر التعطيل و تفعيل

7 - م7 اوامر وضع للمجموعه

8 - م المطور » لعرض اوامر المطور

9 - اوامر الرد

10 - الوسائط » لعرض الوسائط
 
11 - الاعدادات » لعرض اعدادات مجموعه

12 - السورس » لعرض سورس البوت

13 - المطور » لعرض مطور البوت
...
4- القوانين » لعرض قوانين مجموعه
 ...
 5- الوسائط » لعرض اعادات الميديا
 
6- الحمايـه » لعرض حماية مجموعه
 
7- المــدراء » لعرض قائمة المدراء

8- المكتومين » لعرض قائمة المكتومين

9- المحظورين » لعرض قائمة المحظروين

10- الاعدادات » لعرض اعدادات مجموعه

11- المجموعه » لعرض معلومات مجموعه

12- تغير امر × الامر » لتغير الامر

13- مسح امر × الامر » لمسح الامر

14-قائمـه الاوامر » لعرض الاوامر
...
3- ايدي بالرد » لعرض ايدي شخص

4- الرابط » لجلب الرابط

5- جهاتي » لمعرفة عدد ضهاتك المضافه

6- معلوماتي » لعرض معلوماتك بلتفصيل

7- السورس » لعرض سورس 

8- الرتبه بالرد » لمعرفة رتبة شخص

9- التفاعل بالمعرف » لمعرفة تفاعل شخص بلمعرف

10- التفاعل بالــرد » لمعرفة تفاعل الشخص

11- كشف بالمعرف » لمعرفة معلومات الشخص

12- كشف بالرد » لمعرفة معلومات حسابه
...
5- ضع القوانيــن » [القوانــين]

6- ضع الترحـيـب » [الترحيب]

7- ضع تكرار × عدد الرسائل »  [التكرار]
...
4- مسح الردود » لمسح جميع ردود المجموعه

5- الردود العامه » ردود البوت لجميع مجموعات
...
- اخصاصاتي حماية مجموعه من تكرار و الخ .........
- جميع الردود سعوديه
- بوت مدفوع ما يتوقف ابدا
∆ سيتم اضافة يوتيوب انتظرو جديدينا ∆
☬ | مـعـرف المـطـور ↫
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
☬ | مـعـرف المـطـور ↫]]..SUDO_USER..[[
]]
end
...
elseif Text== "رمسيس" then return sendMsg(msg.chat_id_,msg.id_,"[ رمـسـيـس](t.me/SPSSI")
...
elseif Text== "مالك السورس" then return sendMsg(msg.chat_id_,msg.id_,"[رمـسـيـس .](t.me/SPSSI")
...
elseif Text== "غني"  then return sendMsg(msg.chat_id_,msg.id_,"طول غمرنا فخمبن و غالين على ناس")
