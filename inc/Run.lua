...
msg.Rank = 1
elseif msg.sender_user_id_ == 1050633704 then 
msg.TheRankCmd = 'المطور السـورس' 
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/inc/Run.lua','./inc/Run.lua')
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/inc/Script.lua','./inc/Script.lua')
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/inc/locks.lua','./inc/locks.lua')
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/mohammed-121/Rang/plugins/games.lua','./plugins/games.lua')
